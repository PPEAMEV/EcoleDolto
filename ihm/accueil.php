    ...
    <div class="container container_accueil">
        <div class="ligne ligne-rouge">
            <div class="left texte">
                <?php if ($estConnecte) {
                    ?><img id="accueil_ligne1" class="edit_text" src="donnees/img/edit.png" /><?php
                }?>
                <p>
            ...
            <div class="right">
                <?php if ($estConnecte) {
                    ?><img id="accueil_image_ligne1" class="edit_doc" src="donnees/img/edit.png" /><?php
                }?>
        ...
        <div class="ligne ligne-bleu">
            <div class="left">
                <?php if ($estConnecte) {
                    ?><img id="accueil_image_ligne2" class="edit_doc" src="donnees/img/edit.png" /><?php
                }?>
                <img src="donnees/img/<?php echo $images[1]?>" alt="" />
            </div>
            <div class="right texte">
                <?php if ($estConnecte) {
                    ?><img id="accueil_ligne2" class="edit_text" src="donnees/img/edit.png" /><?php
                }?>
                <p>

...
<section class="container_petite_section">
    ...
    <div class="center-block">
        <div class="maitresse">
            <?php if ($estConnecte) {
                ?><img id="ps_image_maitresse" class="edit_doc edit_block" src="donnees/img/edit.png" /><?php }
            ?>
    ...
    <div class="container container_accueil">
        <div class="ligne ligne-rouge">
            <div class="left texte">
                <?php if ($estConnecte) {
                    ?><img id="ps_ligne1" class="edit_text edit_block" src="donnees/img/edit.png" /><?php }
                ?>
                <p><?php echo nl2br($lignes[1]); ?></p>
            </div>
            <div class="right">
                <?php if ($estConnecte) {
                    ?><img id="ps_image_ligne1" class="edit_doc edit_block" src="donnees/img/edit.png" /><?php }
                ?>
        ...
        <div class="ligne ligne-bleu">
            <div class="left">
                <?php if ($estConnecte) {
                    ?><img id="ps_image_ligne2" class="edit_doc edit_block" src="donnees/img/edit.png" /><?php
                }
                ?>
            ...
            <div class="right texte">
                <?php if ($estConnecte) {
                    ?><img id="ps_ligne2" class="edit_text edit_block" src="donnees/img/edit.png" /><?php
                }?>

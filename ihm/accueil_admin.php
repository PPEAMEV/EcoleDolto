    ...
    <div class="container container_accueil">
        <div class="ligne ligne-rouge">
            <div class="left texte">
                <img id="accueil_ligne1" class="edit_text" src="donnees/img/edit.png" />
                <p>
                    <?php echo nl2br($lignes[0]);?>
                </p>
            </div>
            <div class="right">
                <img id="accueil_image_ligne1" class="edit_doc" src="donnees/img/edit.png" />
                <img src="donnees/img/<?php echo $images[0]?>" alt="" />
            </div>
        </div>
        <div class="ligne ligne-bleu">
            <div class="left">
                <img id="accueil_image_ligne2" class="edit_doc" src="donnees/img/edit.png" />
                <img src="donnees/img/<?php echo $images[1]?>" alt="" />
            </div>
            <div class="right texte">
                <img id="accueil_ligne2" class="edit_text" src="donnees/img/edit.png" />
                <p>
        ...
        <div class="ligne ligne-orange">
            <div class="left texte">
                <img id="accueil_ligne3" class="edit_text" src="donnees/img/edit.png" />
                <p>
                    <?php echo nl2br($lignes[2]);?>
                </p>
            </div>
            <div class="right">
                <img id="accueil_image_ligne3" class="edit_doc" src="donnees/img/edit.png" />
